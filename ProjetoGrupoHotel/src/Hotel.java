...
public class Hotel {
    ...
    public static void criarReserva(Scanner input) {
        ...
        if (!dataFormatoValido(dataInicio) || !dataFormatoValido(dataFim)) { // confirmar os formatos das datas
            System.out.println("Formato de data inválido.");
            System.out.println();
            return;
        }

        if (!datasOrdemValida(dataInicio, dataFim)) { // confirmar a ordem das datas
        ...
        double total = noites * quartoEscolhido.precoNoite;
    ...
    public static void listarReservas() {
        ...
        if (totalReservas == 0) { // SEM RESERVAS
    ...
    public static void editarReserva(Scanner input) {
        ...
        // manter valores antigos se necessário
        ...
        if (novoNumHospedes < 1 || novoNumHospedes > quarto.capacidade) {
            System.out.println("Erro: número de hóspedes excede a capacidade do quarto.");
            return;
        }
        ...
        for (int i = 0; i < totalReservas; i++) {
            ...
            if (r.ativa && r.idQuarto == reserva.idQuarto && r.id != reserva.id) {
                if (datasConflitam(novaDataInicio, novaDataFim, r.dataInicio, r.dataFim)) {
        ...
        reserva.custoTotal = noites * quarto.precoNoite;
    ...
    public static void cancelarReserva(Scanner input) {
        ...
        System.out.println();
        atualizarOcupacaoQuartos(); // ATUALIZAR METODO OCUPAÇAO DOS QUARTOS
